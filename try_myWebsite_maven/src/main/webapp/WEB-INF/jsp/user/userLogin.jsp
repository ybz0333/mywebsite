...
<div class="container">
    ...
    <form role="form" class="form-signin" method="post" action="<c:url value='/user/doUserLogin.action'/>">
        <h2 class="form-signin-heading" style="font-weight: bold;">登录</h2>
        ...
        <div style="color: #ED1C24">${errors.userError }</div>
        ...
        <p style="margin-top: 5px">
	        ...
	        <a href="<c:url value='/user/userRegist.action'/>">
	        	<button type="button" class="btn btn-large btn-primary" style="margin-left: 15px">注册</button>
	        </a>
        </p>
        <c:if test="${showSnapshotLink != null }">
	        <p style="font-size: 1.5em">
	        	<a href="<c:url value='/chatroom/snapshot.action'/>"><strong>看一眼聊天室</strong></a>
	        </p>
        </c:if>
    </form>
