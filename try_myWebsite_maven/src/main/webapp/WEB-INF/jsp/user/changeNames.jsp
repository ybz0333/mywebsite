...
<div class="container">
    ...
    <form role="form" class="form-signin" method="post" action="<c:url value='/user/doChangeNames.action'/>">
        ...
        <div class="form-group">
	        ...
	        <input id="newUsername" type="text" name="newUsername" value="${username }" class="form-control" placeholder="用户名">
		</div>
		<div class="form-group">
	        <label for="newNickname" class="control-label">昵称：</label>
        	<input id="newNickname" type="text" name="newNickname" value="${nickname }" class="form-control" placeholder="昵称">
        </div>
